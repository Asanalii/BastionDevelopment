...
const activeModalKey = ref(""); // "" | turnkey | general | networks | vlkl | license
...
const modalDataMap = {
  ...
  networks: {
    title: "Наружные и внутренние инженерные сети",
    subtitle: "Проектирование, монтаж, подключение и сдача сетей.",
    blocks: [
      {
        title: "Наружные сети",
        items: [
          "Водоснабжение (магистрали, вводы, колодцы)",
          "Канализация (самотечная/напорная, коллекторы, камеры)",
          "Тепловые сети (при необходимости)",
          "Подготовка трасс, земляные работы, восстановление благоустройства",
        ],
      },
      {
        title: "Внутренние сети",
        items: [
          "Водоснабжение и канализация",
          "Отопление",
          "Вентиляция и кондиционирование",
          "Электроснабжение и освещение",
          "Слаботочные системы (связь, интернет, видеонаблюдение — если предусмотрено проектом)",
        ],
      },
      {
        title: "Завершение работ",
        items: [
          "Испытания и опрессовка (где требуется)",
          "Пусконаладка оборудования",
          "Подготовка исполнительной документации",
        ],
      },
    ],
    // note: "Описание составлено по логике «под ключ»: проектирование/монтаж/испытания/пусконаладка/исполнительная документация.",
  },

  vlkl: {
    title: "ВЛ и КЛ 0,4–35–110 кВ",
    subtitle: "Строительство и реконструкция линий электроснабжения.",
    blocks: [
      {
        title: "Воздушные линии (ВЛ)",
        items: [
          "Строительство и реконструкция ВЛ",
          "Монтаж опор, арматуры, проводов",
          "Замена участков и узлов (при модернизации)",
        ],
      },
      {
        title: "Кабельные линии (КЛ)",
        items: [
          "Прокладка кабеля, устройство трасс",
          "Муфты, вводы, соединения",
          "Маркировка и защита трассы",
        ],
      },
      {
        title: "Испытания и ввод в работу",
        items: [
          "Электроиспытания",
    ...
    // note: "Фокус: строительство/реконструкция, испытания и пусконаладка — как в кратком описании карточки.",
  },

  license: {
    title: "СМР по лицензии I категории",
    subtitle: "Работы по нормам и требованиям на ответственных объектах.",
    blocks: [
      {
        title: "Что это означает для заказчика",
        items: [
          "Работаем в правовом поле и по регламентам",
          "Соблюдение требований безопасности и качества",
          "Контроль сроков и прозрачность по этапам",
        ],
      },
      {
        title: "Типовые виды работ",
        items: [
      ...
      {
        title: "Документы и сдача",
        items: [
          "Исполнительная документация",
          "Сдача работ по этапам",
          "Подготовка пакета для ввода/приёмки (если требуется)",
        ],
      },
    ],
    // note: "Этот блок сделан как «блок доверия»: что даёт лицензия и как это влияет на процесс работ.",
  },
};
...
<template>
  <section class="activitySimple section" id="activity">
    <div class="container">
      ...
      <div class="grid activitySimple__grid">
        <button
          ...
          :key="card.key"
          type="button"
          class="card card-pad activitySimple__card activitySimple__card--clickable"
          @click="openModalByCard(card)"
        >
          <div class="activitySimple__cardTitle">
            {{ card.title }}
            <span class="activitySimple__hint">Подробнее</span>
          </div>
    ...
    <teleport to="body">
      <div v-if="isModalOpen" class="activityModal" @click="onBackdropClick">
